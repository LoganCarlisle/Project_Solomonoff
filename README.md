...
> ** Research Preview:** This repository is currently in active development. 
**Project Solomonoff** is a Hypernetwork framework designed to scale **Hypernets** to the foundation model era.
---
...
**Project Solomonoff** is a research framework investigating the compression of knowledge,testing the hypothesis that the weight manifolds of Large Language Models are highly compressible from what we know weights are about truly 3.5 bits and due to Shannons laws tricky to compress anymore without losing info.
...
change --> now taking a image gen aproach no more low rank factors 

### The HyperNET Architecture

currently trying to copy sota video generation but use graph gnn to capture the computational graphs of target models
